...
namespace Tool.Bundles.Examples
{
    ...
    {
        private const string UrlAssetBundleBackgrounds = "https://drive.google.com/uc?export=download&id=1y2gUPCn4mUzfZ6W8L7K4NeNitS03_Pn8";
        ...
        protected IEnumerator DownloadAndSetBackgroundsAssetBundles()
        {
